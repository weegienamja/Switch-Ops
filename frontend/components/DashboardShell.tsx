      ...
      <div className="app-shell">
        ...
        <div className="container">
          <header className="ewps-standalone-header">
            <div className="ewps-standalone-header__brand"><div className="header__logo">SO</div><div><strong>SwitchOps Research</strong><span>EWPS v0.2.3 Alpha · Scenario Phase Provenance</span></div></div>
